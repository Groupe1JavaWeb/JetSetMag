...
hibernate {
    cache.use_second_level_cache = false // disable second level cache
...
environments {
    ...
    test {
        dataSource {
			...
			url = "jdbc:mysql://localhost/JetSetMagTest?useUnicode=yes&characterEncoding=UTF-8"
        }
    }
    production {
        dataSource {
			...
			url = "jdbc:mysql://localhost/JetSetMagV1?useUnicode=yes&characterEncoding=UTF-8"
            properties {
