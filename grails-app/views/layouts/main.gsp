...
<li>
<a href="/JetSetMagnav,.navbar-header" data-toggle="class:nav-xs,nav-xs" class="text-muted">
...
<li >
<a href="/JetSetMagtable" class="auto">
<span class="pull-right text-muted">
<i class="fa fa-angle-left text"></i>
<i class="fa fa-angle-down text-active"></i>
</span>
...
<li >
<a href="/JetSetMagform" class="auto">
<span class="pull-right text-muted">
<i class="fa fa-angle-left text"></i>
<i class="fa fa-angle-down text-active"></i>
</span>
