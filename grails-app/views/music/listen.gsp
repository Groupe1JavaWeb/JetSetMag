            ...
            <header class="bg-black lter header header-md navbar navbar-fixed-top-xs">
                <div class="navbar-header aside bg-success nav-xs">
                    ...
                    <ul class="nav navbar-nav hidden-xs">
                        <li>
                            <a href="listen.html#nav,.navbar-header" data-toggle="class:nav-xs,nav-xs" class="text-muted">
                    ...
                    <form class="navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs" role="search">
                        ...
                        <div class="navbar-right ">
                            <ul class="nav navbar-nav m-n hidden-xs nav-user user">
                                <li class="hidden-xs">
                                    <a href="listen.html#" class="dropdown-toggle lt" data-toggle="dropdown">
                                        <i class="icon-bell"></i>
                                    ...
                                    <section class="dropdown-menu aside-xl animated fadeInUp">
                                        <section class="panel bg-white">
                                            ...
                                            <div class="list-group list-group-alt">
                                                <a href="listen.html#" class="media list-group-item">
                                                    <span class="pull-left thumb-sm">
                                                        ...
                                                        <div class="panel-footer text-sm">
                                                            <a href="listen.html#" class="pull-right">
                                                                <i class="fa fa-cog"></i>
                                                            </a>
                                                            <a href="listen.html#notes" data-toggle="class:show animated fadeInRight">See all the notifications</a>
                                                        </div>
                                                    </section>
                                                </section>
                                            </li>
                                            <li class="dropdown">
                                                <a href="listen.html#" class="dropdown-toggle bg clear" data-toggle="dropdown">
                                                                ...
                                                                <ul class="nav" data-ride="collapse">
                                                                    ...
                                                                    <li >
                                                                        ...
                                                                        <ul class="nav dk text-sm">
                                                                            ...
                                                                            <li >
                                                                                <a href="listen.html#table" class="auto">
                                                                                    <span class="pull-right text-muted">
                                                                                        <i class="fa fa-angle-left text"></i>
                                                                                        <i class="fa fa-angle-down text-active"></i>
                                                                                    </span>
                                                                            ...
                                                                            <li >
                                                                                <a href="listen.html#form" class="auto">
                                                                                    <span class="pull-right text-muted">
                                                                                        <i class="fa fa-angle-left text"></i>
                                                                                        <i class="fa fa-angle-down text-active"></i>
                                                                                    </span>
                                                    ...
                                                    <footer class="footer hidden-xs no-padder text-center-nav-xs">
                                                        <div class="bg hidden-xs ">
                                                            <div class="dropdown dropup wrapper-sm clearfix">
                                                                <a href="listen.html#" class="dropdown-toggle" data-toggle="dropdown">
                                                                        ...
                                                                        <section class="scrollable">
                                                                            <div class="m-t-n-xxs item pos-rlt">
                                                                                ...
                                                                                <div class="bottom gd bg-info wrapper-lg">
                                                                                    <span class="pull-right text-sm">101,400 
                                                                                        <br>Followers
                                                                                        </span>
                                                                                    ...
                                                                                    <ul class="list-group list-group-lg no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                                                                                        <li class="list-group-item">
                                                                                            <div class="pull-right m-l">
                                                                                                <a href="listen.html#" class="m-r-sm">
                                                                                            ...
                                                                                            <a href="listen.html#" class="jp-play-me m-r-sm pull-left">
                                                                                ...
                                                                                <section class="scrollable hover">
                                                                                    <ul class="list-group list-group-lg no-bg auto m-b-none m-t-n-xxs">
                                                                                        <li class="list-group-item clearfix">
                                                                                            <a href="listen.html#" class="jp-play-me pull-right m-t-sm m-l text-md">
                                                                                                <i class="icon-control-play text"></i>
                                                                                                <i class="icon-control-pause text-active"></i>
                                                                                            </a>
                                                                                            <a href="listen.html#" class="pull-left thumb-sm m-r">
                                                                                                <img src="images/m0.jpg" alt="...">
                                                                                                </a>
                                                                                                <a class="clear" href="listen.html#">
                                                                                                                    ...
                                                                                                                    <li class="list-group-item clearfix">
                                                                                                                        ...
                                                                                                                        <section class="col-sm-3 no-padder lt">
                                                                                                                            <section class="vbox">
                                                                                                                                <section class="scrollable hover">
                                                                                                                                    <div class="m-t-n-xxs">
                                                                                                                                        <div class="item pos-rlt">
                                                                                                                                            <a href="listen.html#" class="item-overlay active opacity wrapper-md font-xs">
                                                                                                                                            ...
                                                                                                                                            <div class="item pos-rlt">
                                                                                                                                                <a href="listen.html#" class="item-overlay active opacity wrapper-md font-xs text-right">
                                                                                                                                                    <span class="block h3 font-bold text-warning text-u-c">Listen</span>
                                                                                                                                                    <span class="text-muted">Find the peace in your heart</span>
                                                                                                                                                    <span class="bottom wrapper-md block">
                                                                                                                                                        <i class="icon-arrow-right i-lg pull-left"></i> -
                                                                                                                                                    </span>
                                                                                                                                                </a>
                                                                                                                                                <a href="listen.html#">
                                                                                                                                ...
                                                                                                                                <a href="listen.html#" class="hide nav-off-screen-block" data-toggle="class:nav-off-screen,open" data-target="#nav,html"></a>
                                                                                                                            </section>
                                                                                                                        </section>
                                                                                                                    </section>
                                                                                                                </section>
