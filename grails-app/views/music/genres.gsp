            ...
            <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
                <div class="navbar-header aside bg-info dk nav-xs">
                    ...
                    <ul class="nav navbar-nav hidden-xs">
                        <li>
                            <a href="genres.html#nav,.navbar-header" data-toggle="class:nav-xs,nav-xs" class="text-muted">
                    ...
                    <form class="navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs" role="search">
                        ...
                        <div class="navbar-right ">
                            <ul class="nav navbar-nav m-n hidden-xs nav-user user">
                                <li class="hidden-xs">
                                    <a href="genres.html#" class="dropdown-toggle lt" data-toggle="dropdown">
                                        <i class="icon-bell"></i>
                                    ...
                                    <section class="dropdown-menu aside-xl animated fadeInUp">
                                        <section class="panel bg-white">
                                            ...
                                            <div class="list-group list-group-alt">
                                                <a href="genres.html#" class="media list-group-item">
                                                    <span class="pull-left thumb-sm">
                                                        ...
                                                        <div class="panel-footer text-sm">
                                                            <a href="genres.html#" class="pull-right">
                                                                <i class="fa fa-cog"></i>
                                                            </a>
                                                            <a href="genres.html#notes" data-toggle="class:show animated fadeInRight">See all the notifications</a>
                                                        </div>
                                                    </section>
                                                </section>
                                            </li>
                                            <li class="dropdown">
                                                <a href="genres.html#" class="dropdown-toggle bg clear" data-toggle="dropdown">
                                                                ...
                                                                <ul class="nav" data-ride="collapse">
                                                                    ...
                                                                    <li >
                                                                        ...
                                                                        <ul class="nav dk text-sm">
                                                                            ...
                                                                            <li >
                                                                                <a href="genres.html#table" class="auto">
                                                                                    <span class="pull-right text-muted">
                                                                                        <i class="fa fa-angle-left text"></i>
                                                                                        <i class="fa fa-angle-down text-active"></i>
                                                                                    </span>
                                                                            ...
                                                                            <li >
                                                                                <a href="genres.html#form" class="auto">
                                                                                    <span class="pull-right text-muted">
                                                                                        <i class="fa fa-angle-left text"></i>
                                                                                        <i class="fa fa-angle-down text-active"></i>
                                                                                    </span>
                                                    ...
                                                    <footer class="footer hidden-xs no-padder text-center-nav-xs">
                                                        <div class="bg hidden-xs ">
                                                            <div class="dropdown dropup wrapper-sm clearfix">
                                                                <a href="genres.html#" class="dropdown-toggle" data-toggle="dropdown">
                                                                                    ...
                                                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                        <div class="item">
                                                                                            <div class="pos-rlt">
                                                                                                ...
                                                                                                <a href="track-detail.html">
                                                                                                    <img src="images/m2.jpg" alt="" class="r r-2x img-full">
                                                                                                    </a>
                                                                                                </div>
                                                                                                <div class="padder-v">
                                                                                        ...
                                                                                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                            <div class="item">
                                                                                                <div class="pos-rlt">
                                                                                                    ...
                                                                                                    <a href="track-detail.html">
                                                                                                        <img src="images/a10.png" alt="" class="r r-2x img-full">
                                                                                                        </a>
                                                                                                    </div>
                                                                                                    <div class="padder-v">
                                                                                            ...
                                                                                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                <div class="item">
                                                                                                    <div class="pos-rlt">
                                                                                                        ...
                                                                                                        <a href="track-detail.html">
                                                                                                            <img src="images/m4.jpg" alt="" class="r r-2x img-full">
                                                                                                            </a>
                                                                                                        </div>
                                                                                                        <div class="padder-v">
                                                                                                ...
                                                                                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                    <div class="item">
                                                                                                        <div class="pos-rlt">
                                                                                                            ...
                                                                                                            <a href="track-detail.html">
                                                                                                                <img src="images/m5.jpg" alt="" class="r r-2x img-full">
                                                                                                                </a>
                                                                                                            </div>
                                                                                                            <div class="padder-v">
                                                                                                    ...
                                                                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                        <div class="item">
                                                                                                            <div class="pos-rlt">
                                                                                                                ...
                                                                                                                <a href="track-detail.html">
                                                                                                                    <img src="images/m6.jpg" alt="" class="r r-2x img-full">
                                                                                                                    </a>
                                                                                                                </div>
                                                                                                                <div class="padder-v">
                                                                                                        ...
                                                                                                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                            <div class="item">
                                                                                                                <div class="pos-rlt">
                                                                                                                    ...
                                                                                                                    <a href="track-detail.html">
                                                                                                                        <img src="images/m0.jpg" alt="" class="r r-2x img-full">
                                                                                                                        </a>
                                                                                                                    </div>
                                                                                                                    <div class="padder-v">
                                                                                                            ...
                                                                                                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                <div class="item">
                                                                                                                    <div class="pos-rlt">
                                                                                                                        ...
                                                                                                                        <a href="track-detail.html">
                                                                                                                            <img src="images/m8.jpg" alt="" class="r r-2x img-full">
                                                                                                                            </a>
                                                                                                                        </div>
                                                                                                                        <div class="padder-v">
                                                                                                                ...
                                                                                                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                    <div class="item">
                                                                                                                        <div class="pos-rlt">
                                                                                                                            ...
                                                                                                                            <a href="track-detail.html">
                                                                                                                                <img src="images/m9.jpg" alt="" class="r r-2x img-full">
                                                                                                                                </a>
                                                                                                                            </div>
                                                                                                                            <div class="padder-v">
                                                                                                                    ...
                                                                                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                        <div class="item">
                                                                                                                            <div class="pos-rlt">
                                                                                                                                ...
                                                                                                                                <a href="track-detail.html">
                                                                                                                                    <img src="images/m10.jpg" alt="" class="r r-2x img-full">
                                                                                                                                    </a>
                                                                                                                                </div>
                                                                                                                                <div class="padder-v">
                                                                                                                        ...
                                                                                                                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                            <div class="item">
                                                                                                                                <div class="pos-rlt">
                                                                                                                                    ...
                                                                                                                                    <a href="track-detail.html">
                                                                                                                                        <img src="images/m11.jpg" alt="" class="r r-2x img-full">
                                                                                                                                        </a>
                                                                                                                                    </div>
                                                                                                                                    <div class="padder-v">
                                                                                                                            ...
                                                                                                                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                <div class="item">
                                                                                                                                    <div class="pos-rlt">
                                                                                                                                        ...
                                                                                                                                        <a href="track-detail.html">
                                                                                                                                            <img src="images/m12.jpg" alt="" class="r r-2x img-full">
                                                                                                                                            </a>
                                                                                                                                        </div>
                                                                                                                                        <div class="padder-v">
                                                                                                                                ...
                                                                                                                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                    <div class="item">
                                                                                                                                        <div class="pos-rlt">
                                                                                                                                            ...
                                                                                                                                            <a href="track-detail.html">
                                                                                                                                                <img src="images/m13.jpg" alt="" class="r r-2x img-full">
                                                                                                                                                </a>
                                                                                                                                            </div>
                                                                                                                                            <div class="padder-v">
                                                                                                                                    ...
                                                                                                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                        <div class="item">
                                                                                                                                            <div class="pos-rlt">
                                                                                                                                                ...
                                                                                                                                                <a href="track-detail.html">
                                                                                                                                                    <img src="images/m14.jpg" alt="" class="r r-2x img-full">
                                                                                                                                                    </a>
                                                                                                                                                </div>
                                                                                                                                                <div class="padder-v">
                                                                                                                                                    <a href="track-detail.html" data-bjax data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis">Sodales nisi nec condimentum</a>
                                                                                                                                        ...
                                                                                                                                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                            <div class="item">
                                                                                                                                                <div class="pos-rlt">
                                                                                                                                                    ...
                                                                                                                                                    <a href="track-detail.html">
                                                                                                                                                        <img src="images/m15.jpg" alt="" class="r r-2x img-full">
                                                                                                                                                        </a>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="padder-v">
                                                                                                                                            ...
                                                                                                                                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                                <div class="item">
                                                                                                                                                    <div class="pos-rlt">
                                                                                                                                                        ...
                                                                                                                                                        <a href="track-detail.html">
                                                                                                                                                            <img src="images/a9.png" alt="" class="r r-2x img-full">
                                                                                                                                                            </a>
                                                                                                                                                        </div>
                                                                                                                                                        <div class="padder-v">
                                                                                                                                                ...
                                                                                                                                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                                    <div class="item">
                                                                                                                                                        <div class="pos-rlt">
                                                                                                                                                            ...
                                                                                                                                                            <a href="track-detail.html">
                                                                                                                                                                <img src="images/m16.jpg" alt="" class="r r-2x img-full">
                                                                                                                                                                </a>
                                                                                                                                                            </div>
                                                                                                                                                            <div class="padder-v">
                                                                                                                                                    ...
                                                                                                                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                                                                                                                        <div class="item">
                                                                                                                                                            <div class="pos-rlt">
                                                                                                                                                                ...
                                                                                                                                                                <a href="track-detail.html">
                                                                                                                                                                    <img src="images/m17.jpg" alt="" class="r r-2x img-full">
                                                                                                                                                                    </a>
                                                                                                                                                                </div>
                                                                                                                                                                <div class="padder-v">
                                                                                                                                                    ...
                                                                                                                                                    <ul class="pagination pagination">
                                                                                                                                                        ...
                                                                                                                                                        <li class="active">
                                                                                                                                                            <a href="genres.html#">1</a>
                                                                                                                                                        </li>
                                                                                                                                                        <li>
                                                                                                                                                            <a href="genres.html#">2</a>
                                                                                                                                                        </li>
                                                                                                                                                        <li>
                                                                                                                                                            <a href="genres.html#">3</a>
                                                                                                                                                        </li>
                                                                                                                                                        <li>
                                                                                                                                                            <a href="genres.html#">4</a>
                                                                                                                                                        </li>
                                                                                                                                                        <li>
                                                                                                                                                            <a href="genres.html#">5</a>
                                                                                                                                                        </li>
                                                                                                                                                        <li>
                                                                                                                                                            <a href="genres.html#">
                                                                                                                            ...
                                                                                                                            <a href="genres.html#" class="hide nav-off-screen-block" data-toggle="class:nav-off-screen,open" data-target="#nav,html"></a>
                                                                                                                        </section>
                                                                                                                    </section>
                                                                                                                </section>
                                                                                                            </section>
